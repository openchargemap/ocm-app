...
import {PlaceSearchResult} from '../../core/ocm/model/AppModels';
/*
  Component to provide geographic place search lookup
*/
@Component({
    selector: 'place-search',
    templateUrl: 'build/components/place-search/place-search.html'
})
export class PlaceSearch {
    ...
    constructor(private logging: Logging, private changeDetector: ChangeDetectorRef) {
